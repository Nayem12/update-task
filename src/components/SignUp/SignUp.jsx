            ...
            <div>
                <div className='bg-white dark:bg-slate-700 py-5'>
                    <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <h1 className="text-3xl font-semibold text-center text-gray-700 dark:text-white">Task</h1>
                        ...
                        <p className="mt-8 text-xs font-light text-center text-gray-400"> Already a user? <Link to='/login' className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Sign In</Link></p>
                    </div>
                </div>
            </div>
